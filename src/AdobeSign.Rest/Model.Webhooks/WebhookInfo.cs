...
namespace AdobeSign.Rest.Model.Webhooks
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookInfo :  IEquatable<WebhookInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Created">Timestamp when the webhook was created. Will only be returned in GET request. Can&#39;t be modified in PUT request.</param>
        ...
        /// <param name="State">The state in which the webhook should be created.</param>
        ...
        /// <param name="WebhookConditionalParams">Conditions which webhook creator can specify for the payload while creating or updating a webhook.</param>
        ...
        public WebhookInfo(string ApplicationDisplayName = default(string), string ApplicationName = default(string), DateTime? Created = default(DateTime?), string Id = default(string), DateTime? LastModified = default(DateTime?), string Name = default(string), string ResourceId = default(string), ResourceTypeEnum? ResourceType = default(ResourceTypeEnum?), ScopeEnum? Scope = default(ScopeEnum?), StateEnum? State = default(StateEnum?), StatusEnum? Status = default(StatusEnum?), WebhookConditionalParams WebhookConditionalParams = default(WebhookConditionalParams), List<WebhookSubscriptionEventsEnum> WebhookSubscriptionEvents = default(List<WebhookSubscriptionEventsEnum>), WebhookUrlInfo WebhookUrlInfo = default(WebhookUrlInfo))
        {
        ...
        {
            return this.Equals(input as WebhookInfo);
        }

        /// <summary>
        /// Returns true if WebhookInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WebhookConditionalParams == input.WebhookConditionalParams ||
                    (this.WebhookConditionalParams != null &&
                    this.WebhookConditionalParams.Equals(input.WebhookConditionalParams))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WebhookConditionalParams != null)
                    hashCode = hashCode * 59 + this.WebhookConditionalParams.GetHashCode();
