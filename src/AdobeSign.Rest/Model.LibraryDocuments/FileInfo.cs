...
namespace AdobeSign.Rest.Model.LibraryDocuments
{
    ...
    public partial class FileInfo :  IEquatable<FileInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="TransientDocumentId">ID for a transient document that will be added to the library document.</param>
        /// <param name="UrlFileInfo">URL for an external document to add to the library document.</param>
        public FileInfo(string TransientDocumentId = default(string), URLFileInfo UrlFileInfo = default(URLFileInfo))
        {
