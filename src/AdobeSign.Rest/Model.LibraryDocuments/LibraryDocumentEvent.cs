...
namespace AdobeSign.Rest.Model.LibraryDocuments
{
    ...
    /// </summary>
    [DataContract]
    public partial class LibraryDocumentEvent :  IEquatable<LibraryDocumentEvent>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LibraryDocumentEvent);
        }

        /// <summary>
        /// Returns true if LibraryDocumentEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of LibraryDocumentEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LibraryDocumentEvent input)
        {
            if (input == null)
                return false;
