...
namespace AdobeSign.Rest.Model.LibraryDocuments
{
    ...
    /// </summary>
    [DataContract]
    public partial class LibraryDocument :  IEquatable<LibraryDocument>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LibraryDocument" /> class.
        /// </summary>
        /// <param name="CreatorEmail">Email address of the library document creator. It will be ignored in POST/PUT requests.</param>
        /// <param name="Id">The unique identifier that is used to refer to the library template.</param>
        /// <param name="Hidden">True if Library Document is hidden.</param>
        /// <param name="ModifiedDate">The date on which the library document was last modified. Format would be yyyy-MM-dd&#39;T&#39;HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time.</param>
        /// <param name="Name">The name of the library document.</param>
        ...
        public LibraryDocument(string CreatorEmail = default(string), string Id = default(string), bool? Hidden = default(bool?), DateTime? ModifiedDate = default(DateTime?), string Name = default(string), SharingModeEnum? SharingMode = default(SharingModeEnum?), StatusEnum? Status = default(StatusEnum?), List<TemplateTypesEnum> TemplateTypes = default(List<TemplateTypesEnum>))
        {
        ...
        {
            return this.Equals(input as LibraryDocument);
        }

        /// <summary>
        /// Returns true if LibraryDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of LibraryDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LibraryDocument input)
        {
            if (input == null)
                return false;
