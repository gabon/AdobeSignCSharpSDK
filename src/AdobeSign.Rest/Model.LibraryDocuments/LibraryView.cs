...
namespace AdobeSign.Rest.Model.LibraryDocuments
{
    ...
    /// </summary>
    [DataContract]
    public partial class LibraryView :  IEquatable<LibraryView>, IValidatableObject
    {
        /// <summary>
        ...
        public LibraryView(string EmbeddedCode = default(string), DateTime? Expiration = default(DateTime?), bool? IsCurrent = default(bool?), NameEnum? Name = default(NameEnum?), string Url = default(string))
        {
        ...
        {
            return this.Equals(input as LibraryView);
        }

        /// <summary>
        /// Returns true if LibraryView instances are equal
        /// </summary>
        /// <param name="input">Instance of LibraryView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LibraryView input)
        {
            if (input == null)
                return false;
