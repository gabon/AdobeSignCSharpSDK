...
namespace AdobeSign.Rest.Model.Widgets
{
    ...
    /// </summary>
    [DataContract]
    public partial class WidgetView :  IEquatable<WidgetView>, IValidatableObject
    {
        /// <summary>
        ...
        public WidgetView(string EmbeddedCode = default(string), DateTime? Expiration = default(DateTime?), bool? IsCurrent = default(bool?), NameEnum? Name = default(NameEnum?), string Url = default(string))
        {
        ...
        {
            return this.Equals(input as WidgetView);
        }

        /// <summary>
        /// Returns true if WidgetView instances are equal
        /// </summary>
        /// <param name="input">Instance of WidgetView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WidgetView input)
        {
            if (input == null)
                return false;
