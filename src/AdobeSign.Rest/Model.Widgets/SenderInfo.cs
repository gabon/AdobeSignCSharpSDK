...
namespace AdobeSign.Rest.Model.Widgets
{
    ...
    public partial class SenderInfo :  IEquatable<SenderInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Company">Company of the creator, if available..</param>
        /// <param name="Email">Email of the creator of the widget..</param>
        /// <param name="Name">Name of the creator, if available..</param>
        /// <param name="ParticipantId"> The unique identifier of the creator of the widget..</param>
        /// <param name="Self">True if the creator of the widget is the same user that is calling the API..</param>
        public SenderInfo(string Company = default(string), string Email = default(string), string Name = default(string), string ParticipantId = default(string), bool? Self = default(bool?))
        {
