...
namespace AdobeSign.Rest.Model.Widgets
{
    ...
    /// </summary>
    [DataContract]
    public partial class WidgetParticipantSetInfo :  IEquatable<WidgetParticipantSetInfo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WidgetParticipantSetInfo);
        }

        /// <summary>
        /// Returns true if WidgetParticipantSetInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of WidgetParticipantSetInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WidgetParticipantSetInfo input)
        {
            if (input == null)
                return false;
