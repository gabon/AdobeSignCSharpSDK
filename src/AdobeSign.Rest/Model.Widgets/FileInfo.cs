...
namespace AdobeSign.Rest.Model.Widgets
{
    ...
    public partial class FileInfo :  IEquatable<FileInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Document">A document that is associated with the widget. This field cannot be provided in POST call. In case of GET call, this is the only field returned in the response.</param>
        /// <param name="TransientDocumentId">ID for a transient document that will be added to the widget.</param>
        /// <param name="UrlFileInfo">URL for an external document to add to the agreement.</param>
        public FileInfo(Document Document = default(Document), string TransientDocumentId = default(string), URLFileInfo UrlFileInfo = default(URLFileInfo))
        {
        ...
        /// </summary>
        /// <value>ID for a transient document that will be added to the widget</value>
