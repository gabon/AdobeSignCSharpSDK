...
namespace AdobeSign.Rest.Model.Users
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserGroupsInfo :  IEquatable<UserGroupsInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroupsInfo" /> class.
        /// </summary>
        /// <param name="GroupInfoList">The list of groups for given user..</param>
        public UserGroupsInfo(List<UserGroupInfo> GroupInfoList = default(List<UserGroupInfo>))
        {
        ...
        {
            return this.Equals(input as UserGroupsInfo);
        }

        /// <summary>
        /// Returns true if UserGroupsInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupsInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupsInfo input)
        {
            if (input == null)
                return false;
