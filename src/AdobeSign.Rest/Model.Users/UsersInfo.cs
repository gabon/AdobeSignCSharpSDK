...
namespace AdobeSign.Rest.Model.Users
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersInfo :  IEquatable<UsersInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersInfo" /> class.
        /// </summary>
        ...
        public UsersInfo(PageInfo Page = default(PageInfo), List<UserInfo> UserInfoList = default(List<UserInfo>))
        {
            this.Page = Page;
        ...
        {
            return this.Equals(input as UsersInfo);
        }

        /// <summary>
        /// Returns true if UsersInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersInfo input)
        {
            if (input == null)
                return false;
