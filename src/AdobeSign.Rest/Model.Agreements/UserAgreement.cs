...
namespace AdobeSign.Rest.Model.Agreements
{
    ...
    public partial class UserAgreement :  IEquatable<UserAgreement>, IValidatableObject
    {
        ...
        public UserAgreement(DateTime? DisplayDate = default(DateTime?), List<DisplayParticipantSetInfo> DisplayParticipantSetInfos = default(List<DisplayParticipantSetInfo>), string Id = default(string), bool? Esign = default(bool?), bool? Hidden = default(bool?), string LatestVersionId = default(string), string Name = default(string), StatusEnum? Status = default(StatusEnum?))
        {
