...
namespace AdobeSign.Rest.Model.Agreements
{
    ...
    public partial class ExternalId :  IEquatable<ExternalId>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Id">An arbitrary value from your system, which can be specified at sending time and then later returned or queried.</param>
        public ExternalId(string Id = default(string))
        {
            this.Id = Id;
        }
