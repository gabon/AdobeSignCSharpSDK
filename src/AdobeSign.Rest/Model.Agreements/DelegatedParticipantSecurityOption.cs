...
namespace AdobeSign.Rest.Model.Agreements
{
    ...
    /// </summary>
    [DataContract]
    public partial class DelegatedParticipantSecurityOption :  IEquatable<DelegatedParticipantSecurityOption>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DelegatedParticipantSecurityOption);
        }

        /// <summary>
        /// Returns true if DelegatedParticipantSecurityOption instances are equal
        /// </summary>
        /// <param name="input">Instance of DelegatedParticipantSecurityOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DelegatedParticipantSecurityOption input)
        {
            if (input == null)
                return false;
