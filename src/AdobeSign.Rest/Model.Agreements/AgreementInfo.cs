...
namespace AdobeSign.Rest.Model.Agreements
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgreementInfo :  IEquatable<AgreementInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgreementInfo" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AgreementInfo);
        }

        /// <summary>
        /// Returns true if AgreementInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of AgreementInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgreementInfo input)
        {
            if (input == null)
                return false;
