...
namespace AdobeSign.Rest.Model.Agreements
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgreementViewInfo :  IEquatable<AgreementViewInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgreementViewInfo" /> class.
        /// </summary>
        /// <param name="CommonViewConfiguration">Common view configuration for all the available views.</param>
        /// <param name="ComposeViewConfiguration">Compose page view configuration.</param>
        /// <param name="Name">Name of the requested agreement view.</param>
        public AgreementViewInfo(CommonViewConfiguration CommonViewConfiguration = default(CommonViewConfiguration), ComposeViewConfiguration ComposeViewConfiguration = default(ComposeViewConfiguration), NameEnum? Name = default(NameEnum?))
        {
        ...
        {
            return this.Equals(input as AgreementViewInfo);
        }

        /// <summary>
        /// Returns true if AgreementViewInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of AgreementViewInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgreementViewInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ComposeViewConfiguration == input.ComposeViewConfiguration ||
                    (this.ComposeViewConfiguration != null &&
                    this.ComposeViewConfiguration.Equals(input.ComposeViewConfiguration))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ComposeViewConfiguration != null)
                    hashCode = hashCode * 59 + this.ComposeViewConfiguration.GetHashCode();
                if (this.Name != null)
