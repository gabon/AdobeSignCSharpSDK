...
namespace AdobeSign.Rest.Model.Agreements
{
    ...
    public partial class ShareParticipantInfo :  IEquatable<ShareParticipantInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Company">Company of the sharee participant, if available..</param>
        /// <param name="Email">Email of the sharee participant of the agreement..</param>
        /// <param name="Name">Name of the sharee participant, if available..</param>
        /// <param name="ParticipantId">The unique identifier of the sharee participant of the agreement..</param>
        /// <param name="SharerParticipantId">The unique identifier of the participant who shared the agreement..</param>
