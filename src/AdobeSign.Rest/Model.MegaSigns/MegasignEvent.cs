...
namespace AdobeSign.Rest.Model.MegaSigns
{
    ...
    /// </summary>
    [DataContract]
    public partial class MegasignEvent :  IEquatable<MegasignEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MegasignEvent" /> class.
        /// </summary>
        ...
        /// <param name="Type">Type of MegaSign event.</param>
        ...
        {
            return this.Equals(input as MegasignEvent);
        }

        /// <summary>
        /// Returns true if MegasignEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of MegasignEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MegasignEvent input)
        {
            if (input == null)
                return false;
