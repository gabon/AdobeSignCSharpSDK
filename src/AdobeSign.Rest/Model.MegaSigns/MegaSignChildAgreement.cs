...
namespace AdobeSign.Rest.Model.MegaSigns
{
    ...
    /// </summary>
    [DataContract]
    public partial class MegaSignChildAgreement :  IEquatable<MegaSignChildAgreement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MegaSignChildAgreement" /> class.
        /// </summary>
        ...
        /// <param name="Status">This is a server generated attribute which provides the detailed status of an agreement with respect to the apiCaller.</param>
        public MegaSignChildAgreement(DateTime? DisplayDate = default(DateTime?), string Id = default(string), bool? Esign = default(bool?), string Name = default(string), StatusEnum? Status = default(StatusEnum?))
        {
        ...
        {
            return this.Equals(input as MegaSignChildAgreement);
        }

        /// <summary>
        /// Returns true if MegaSignChildAgreement instances are equal
        /// </summary>
        /// <param name="input">Instance of MegaSignChildAgreement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MegaSignChildAgreement input)
        {
            if (input == null)
                return false;
