...
${nuget_cmd} install src/AdobeSign.Rest/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AdobeSign.Rest.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AdobeSign.Rest.dll \
-recurse:'src/AdobeSign.Rest/*.cs' \
-doc:bin/AdobeSign.Rest.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AdobeSign.Rest.dll was created successfully"
fi
