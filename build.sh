...
${nuget_cmd} install src/AdobeSign.Api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AdobeSign.Api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AdobeSign.Api.dll \
-recurse:'src/AdobeSign.Api/*.cs' \
-doc:bin/AdobeSign.Api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AdobeSign.Api.dll was created successfully"
fi
