...
- API version: 6.0.0
- SDK version: 1.0.0
- Build package: AdobeSign.Api.codegen.languages.CSharpClientCodegen
...
The `AdobeSign.Api.dll` will be generated at  `<AdobeSignCSharpSDK>/bin`.
...
```
nuget pack -Build -OutputDirectory out AdobeSign.Api.csproj
```
...
```csharp
      namespace AdobeSign.Api.Client
      {
          /// <summary>
